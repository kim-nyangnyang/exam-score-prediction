...
## ⭐상세 내용 확인
- 프로젝트 상세 보고서는 PDF 슬라이드 자료를 참고해 주세요[성적예측 프로젝트_김새한.pdf](https://github.com/user-attachments/files/24989960/_.pdf)

- 00 보고서 : [효율적 성적 향상을 위한 전략 수립:통계분석 및 머신러닝을 통한 성적예측 모델링](report/당뇨진단예측보고서.pdf)
